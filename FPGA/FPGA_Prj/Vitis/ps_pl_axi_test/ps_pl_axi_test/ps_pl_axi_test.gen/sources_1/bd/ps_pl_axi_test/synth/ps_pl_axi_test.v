...
//Date        : Sun Feb  1 03:49:04 2026
//Host        : DESKTOP-717IMMS running 64-bit major release  (build 9200)
//Command     : generate_target ps_pl_axi_test.bd
//Design      : ps_pl_axi_test
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "ps_pl_axi_test,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ps_pl_axi_test,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_ps7_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "ps_pl_axi_test.hwdef" *) 
module ps_pl_axi_test
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  ps_pl_axi_test_PS_PL_AXI_0_0 PS_PL_AXI_0
       (.LED(LED_0),
        .rece_LED(rece_LED_0),
  ...
  ps_pl_axi_test_axi_smc_0 axi_smc
  ...
  ps_pl_axi_test_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  ps_pl_axi_test_rst_ps7_0_50M_0 rst_ps7_0_50M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
