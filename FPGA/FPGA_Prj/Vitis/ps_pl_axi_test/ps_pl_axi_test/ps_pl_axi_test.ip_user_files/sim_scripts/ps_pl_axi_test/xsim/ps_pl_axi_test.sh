...
#
# Script generated by Vivado on Sun Feb 01 03:49:05 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ps_pl_axi_test.sh
...
#
# Usage        : ps_pl_axi_test.sh
#                ps_pl_axi_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ps_pl_axi_test.sh [-rerun]
#                ps_pl_axi_test.sh [-reset_run]
#                ps_pl_axi_test.sh [-clean]
#                ps_pl_axi_test.sh [-reset_log]
#                ps_pl_axi_test.sh [-help]
#
...
# script info
echo -e "ps_pl_axi_test.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ps_pl_axi_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_36 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ps_pl_axi_test xil_defaultlib.ps_pl_axi_test xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ps_pl_axi_test -key {Behavioral:sim_1:Functional:ps_pl_axi_test} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_6b75.protoinst" -protoinst "protoinst_files/ps_pl_axi_test.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ps_pl_axi_test.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ps_pl_axi_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ps_pl_axi_test.sh [-help]\n\
Usage: ps_pl_axi_test.sh [-step]\n\
Usage: ps_pl_axi_test.sh [-lib_map_path]\n\
Usage: ps_pl_axi_test.sh [-rerun]\n\
Usage: ps_pl_axi_test.sh [-reset_run]\n\
Usage: ps_pl_axi_test.sh [-clean]\n\
Usage: ps_pl_axi_test.sh [-reset_log]\n\
Usage: ps_pl_axi_test.sh [-keep_index]\n\
Usage: ps_pl_axi_test.sh [-noclean_files]\n\n\
