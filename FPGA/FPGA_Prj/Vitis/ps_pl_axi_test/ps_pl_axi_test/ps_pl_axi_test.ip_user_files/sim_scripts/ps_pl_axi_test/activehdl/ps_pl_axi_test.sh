...
#                script (type 'ps_pl_axi_test.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/FPGA_Prj/ps_pl_axi_test/ps_pl_axi_test/ps_pl_axi_test.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
