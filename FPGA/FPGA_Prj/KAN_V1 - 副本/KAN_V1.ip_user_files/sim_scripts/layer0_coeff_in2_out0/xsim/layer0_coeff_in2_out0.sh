...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot layer0_coeff_in2_out0 xil_defaultlib.layer0_coeff_in2_out0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim layer0_coeff_in2_out0 -key {Behavioral:sim_1:Functional:layer0_coeff_in2_out0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb layer0_coeff_in2_out0.wdb xsim.dir libdpi.so)
