...
HD_PWD='D:/KAN/FPGA_Prj/KAN_V1/KAN_V1.runs/layer0_coeff_in1_out0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log layer0_coeff_in1_out0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source layer0_coeff_in1_out0.tcl
