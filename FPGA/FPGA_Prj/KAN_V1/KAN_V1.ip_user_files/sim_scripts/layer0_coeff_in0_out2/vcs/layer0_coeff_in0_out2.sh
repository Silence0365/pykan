...
#
# Script generated by Vivado on Thu Jan 08 21:18:57 +0800 2026
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : layer0_coeff_in0_out2.sh
...
#
# Usage        : layer0_coeff_in0_out2.sh
#                layer0_coeff_in0_out2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                layer0_coeff_in0_out2.sh [-reset_run]
#                layer0_coeff_in0_out2.sh [-reset_log]
#                layer0_coeff_in0_out2.sh [-help]
#
...
#                script (type 'layer0_coeff_in0_out2.sh -help' for more information).
#
...
# script info
echo -e "layer0_coeff_in0_out2.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./layer0_coeff_in0_out2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.layer0_coeff_in0_out2 xil_defaultlib.glbl -o layer0_coeff_in0_out2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./layer0_coeff_in0_out2_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key layer0_coeff_in0_out2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc layer0_coeff_in0_out2_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./layer0_coeff_in0_out2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: layer0_coeff_in0_out2.sh [-help]\n\
Usage: layer0_coeff_in0_out2.sh [-step]\n\
Usage: layer0_coeff_in0_out2.sh [-lib_map_path]\n\
Usage: layer0_coeff_in0_out2.sh [-reset_run]\n\
Usage: layer0_coeff_in0_out2.sh [-reset_log]\n\
Usage: layer0_coeff_in0_out2.sh [-keep_index]\n\
Usage: layer0_coeff_in0_out2.sh [-noclean_files]\n\n\
