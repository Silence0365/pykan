...
HD_PWD='D:/KAN/FPGA_Prj/KAN_V1/KAN_V1.runs/layer1_coeff_in2_out0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log layer1_coeff_in2_out0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source layer1_coeff_in2_out0.tcl
