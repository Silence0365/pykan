...
# === Save Model ===
torch.save(model.state_dict(), 'QAT_KAN/checkpoints/Raw_model.pth')
...
plot_loss(
    ...
    title='Energy',
    ylabel='Energy Loss',
    save_path='QAT_KAN/plots/Raw_model_loss_energy.png',
    color_train='blue',
    color_val='cyan'
)
...
plot_loss(
    ...
    title='Force',
    ylabel='Force Loss',
    save_path='H2O_KAN/plots/Raw_model_loss_force.png',
    color_train='red',
    color_val='orange'
)